...
if __name__ == '__main__':
	...
	np.save("%s/observed_nnu%d_nsim%d"%(dirstr,N_NU,NUM_SIMS),x_in)
	np.save("%s/fg_nnu%d_nsim%d"%(dirstr,N_NU,NUM_SIMS),x_out)
	np.save("%s/cosmo_nnu%d_nsim%d"%(dirstr,N_NU,NUM_SIMS),cosmo_arr)